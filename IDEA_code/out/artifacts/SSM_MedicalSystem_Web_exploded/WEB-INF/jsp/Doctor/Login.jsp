...
<div class="container">
    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            <form action="${pageContext.request.contextPath}/Doctor/LoginValid" method="post">
                <div class="form-group">
                    <label for="account">账号</label>
                    <input type="text" name="account" class="form-control" id="account" placeholder="编号/电话/邮箱" required>
                </div>
                <div class="form-group">
